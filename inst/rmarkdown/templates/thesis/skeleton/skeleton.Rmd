...
<<<<<<< HEAD
output:
#  liondown::thesis_pdf: default
  liondown::thesis_gitbook: default
#  liondown::thesis_word: default
#  liondown::thesis_epub: default
...
# This will automatically install the {remotes} package and {liondown}
# Change this to FALSE if you'd like to install them manually on your own.
params:
  'Install needed packages for {liondown}': True
...
>>>>>>> 2f14a725d0e9ccbf1ff625f62e489fdec07349b6
...
# This chunk ensures that the liondown package is
# installed and loaded. This liondown package includes
# the template files for the thesis.
if (!require(remotes)) {
  if (params$`Install needed packages for {liondown}`) {
...
if (!require(liondown)) {
  if (params$`Install needed packages for {liondown}`) {
    remotes::install_github("ismayc/liondown")
  } else {
    stop(
      paste(
        "You need to run",
